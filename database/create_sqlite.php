...
sqlite_query($dbh, "CREATE INDEX idx_groups_date_create ON groups (date_create);");
sqlite_query($dbh, "CREATE INDEX idx_groups_uid ON groups (uid_cat);");
sqlite_query($dbh, "CREATE UNIQUE INDEX links_uid_cat_key ON links (uid_cat, uid_group);");
sqlite_close($dbh);
}
